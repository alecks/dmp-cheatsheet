...
\begin{itemize}
	...
	%
	\item \textbf{Properties} of \(\bar{X}\): \(\mathbb{E}(\mu)\), \(\operatorname{Var}(\bar(X) = \frac{\sigma}{n})\), \(\operatorname{SD}(\bar{X}) = \frac{\sigma}{\sqrt{n}}\). If the \(X_i\) are normal, so is \(\bar{X}\).
	%
